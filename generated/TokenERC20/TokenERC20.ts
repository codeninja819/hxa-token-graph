...
export class TokenERC20__checkpointsResultValue0Struct extends ethereum.Tuple {
...
export class TokenERC20__getPlatformFeeInfoResult {
  value0: Address;
  value1: i32;
...
export class TokenERC20__verifyResult {
  value0: boolean;
  value1: Address;
...
export class TokenERC20__verifyInput_reqStruct extends ethereum.Tuple {
  get to(): Address {
    return this[0].toAddress();
  }
...
export class TokenERC20 extends ethereum.SmartContract {
  static bind(address: Address): TokenERC20 {
    return new TokenERC20("TokenERC20", address);
  }
  ...
  checkpoints(
    account: Address,
    pos: BigInt
  ): TokenERC20__checkpointsResultValue0Struct {
    let result = super.call(
      "checkpoints",
    ...
    return changetype<TokenERC20__checkpointsResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_checkpoints(
    account: Address,
    pos: BigInt
  ): ethereum.CallResult<TokenERC20__checkpointsResultValue0Struct> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):((uint32,uint224))",
      [
    ...
    return ethereum.CallResult.fromValue(
      changetype<TokenERC20__checkpointsResultValue0Struct>(value[0].toTuple())
    );
  }
  ...
  getPlatformFeeInfo(): TokenERC20__getPlatformFeeInfoResult {
    let result = super.call(
      "getPlatformFeeInfo",
    ...
    return new TokenERC20__getPlatformFeeInfoResult(
      result[0].toAddress(),
      result[1].toI32()
    );
  }
  ...
  try_getPlatformFeeInfo(): ethereum.CallResult<
    TokenERC20__getPlatformFeeInfoResult
  > {
    let result = super.tryCall(
      "getPlatformFeeInfo",
      "getPlatformFeeInfo():(address,uint16)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new TokenERC20__getPlatformFeeInfoResult(
        value[0].toAddress(),
        value[1].toI32()
      )
    );
  ...
  verify(
    _req: TokenERC20__verifyInput_reqStruct,
    _signature: Bytes
  ): TokenERC20__verifyResult {
    let result = super.call(
      "verify",
    ...
    return new TokenERC20__verifyResult(
      result[0].toBoolean(),
      result[1].toAddress()
    );
  }
  ...
  try_verify(
    _req: TokenERC20__verifyInput_reqStruct,
    _signature: Bytes
  ): ethereum.CallResult<TokenERC20__verifyResult> {
    let result = super.tryCall(
      "verify",
      "verify((address,address,uint256,uint256,address,uint128,uint128,bytes32),bytes):(bool,address)",
      [ethereum.Value.fromTuple(_req), ethereum.Value.fromBytes(_signature)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new TokenERC20__verifyResult(value[0].toBoolean(), value[1].toAddress())
    );
  }
}
